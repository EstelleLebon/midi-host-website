...
import { HeaderMenuButton } from '../client/HeaderMenuButton';


const Header = () => {
    return (
        <nav className="w-full mx-auto h-80px flex items-center justify-between px-4" style={{maxHeight: "80px", backgroundImage: "url('/headbg.png')", backgroundSize: "100%", backgroundPosition: "center"}}>
            <HomeLink />
            <div className="flex flex-wrap gap-4 text-gray-200 relative group justify-center items-center">
